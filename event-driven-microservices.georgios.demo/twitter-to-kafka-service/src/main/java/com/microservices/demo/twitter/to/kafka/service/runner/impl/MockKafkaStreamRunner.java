...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public MockKafkaStreamRunner(TwitterToKafkaServiceConfig configuration, TwitterKafkaStatusListener kafkaListener) {
    ...
    public void start() throws TwitterException {
        final String[] keywords = configuration.getTwitterKeywords().toArray(new String[0]);
        final int minTweetLength = configuration.getMockMinTweetLength();
        final int maxTweetLength = configuration.getMockMaxTweetLength();
        long sleepTimeMs = configuration.getMockSleepMs();
